...
export interface ApiPortfolioPortfolio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Figma: Attribute.String;
    LiveDemo: Attribute.String;
    DemoVideo: Attribute.String;
    Description: Attribute.Blocks;
    slug_icons: Attribute.Relation<
      'api::portfolio.portfolio',
      'manyToMany',
      'api::slug-icon.slug-icon'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiSlugIconSlugIcon extends Schema.CollectionType {
  collectionName: 'slug_icons';
  info: {
    singularName: 'slug-icon';
    pluralName: 'slug-icons';
    displayName: 'slugIcon';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::slug-icon.slug-icon': ApiSlugIconSlugIcon;
    }
  }
}
